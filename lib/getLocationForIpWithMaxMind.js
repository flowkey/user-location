...
export function getLocationForIpWithMaxMind(serviceLookup, sanitize, ip, shouldSanitizeResult = true) {
...
export function sanitizeMaxMindResult(result) {
    ...
    try {
        ...
        throw new Meteor.Error('Failed to sanitize data from the lookup result', e);
    }
